...
function initial(){
    ...
    for (let index = 0; index < 10000; index++) {
        let idx1 = getRandom(5,0)        
        let idx2 = getRandom(5,0)
        let temp = exoticOrder[idx1]
        exoticOrder[idx1]=exoticOrder[idx2]
        exoticOrder[idx2]=temp

        let idx3 = getRandom(28,0)
        let idx4 = getRandom(28,0)
        temp = propOrder[idx3]
        propOrder[idx3]=propOrder[idx4]
        propOrder[idx4]=temp
    }
}
initial()

function funcProp(i, color, number) {
...
let curRace = 0
function funcExotic(i, color, number) {
