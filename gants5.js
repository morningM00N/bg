...
function drawTile() {
    ...
    var _loop8 = function _loop8(_x2) {
        ...
        var _loop10 = function _loop10(_y) {
            ...
            // button.style.fontSize = pageWidth * 15 / 360 + "px"
            // button.style.border = "0px"
            button = funcInsertElement("btnBlue_" + _x2 + "_" + _y, "button", "btnRound", 0.535 + _y * ytic, 0.422 + _x2 * xtic, 0.61 + _y * ytic, 0.472 + _x2 * xtic); //button.style.border = "1px solid black"
